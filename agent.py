...
<head>
  ...
  <style>
    ...
    .corrections-note {{ margin-top: 28px; padding: 16px 18px; background: #f5f5f0; border-left: 4px solid #7b9cdf; font-family: -apple-system, BlinkMacSystemFont, "Helvetica Neue", sans-serif; font-size: 14px; line-height: 1.65; color: #4b4b57; font-style: italic; white-space: pre-wrap; }}
  </style>
</head>
<body>
  <div class="wrapper">
